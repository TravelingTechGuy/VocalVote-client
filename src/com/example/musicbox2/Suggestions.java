...
public class Suggestions extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LinearLayout layout = (LinearLayout) v.findViewById(R.id.container_coverflow);
		layout.addView(getCoverFlow());
	...
	public CoverFlow getCoverFlow() {
		CoverFlow coverFlow = new CoverFlow(getActivity());
	...
	public class ImageAdapter extends BaseAdapter {
		...
		private Integer[] mImageIds = { R.drawable.cp01, R.drawable.cp02,
				R.drawable.cp03, R.drawable.cp04, R.drawable.cp01,
				R.drawable.cp02, R.drawable.cp03, R.drawable.cp04
